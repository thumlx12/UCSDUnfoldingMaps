...
public class LifeExpectancy extends PApplet {
    ...
    public void setup() {
        size(1380, 720, OPENGL);
        map = new UnfoldingMap(this, 100, 0, 1280, 720, new OpenStreetMap.OpenStreetMapProvider());
    ...
    private void shadeCountries() {
        for (Marker marker : countryMarkers) {
            ...
            if (lifeExpByCountry.containsKey(countryId)) {
                ...
                marker.setColor(color(255 - colorLevel, colorLevel, 50));
            } else {
