...
public class HelloWorld extends PApplet {
    ...
    public void setup() {
        size(1280, 720, P2D);  // Set up the Applet window to be 800x600
        ...
        map1 = new UnfoldingMap(this, 20, 20, 400, 600, provider);
        ...
        map2 = new UnfoldingMap(this, 450, 20, 400, 600, provider);
        map2.zoomAndPanTo(zoomLevel, new Location(26.793f, 117.793f));
